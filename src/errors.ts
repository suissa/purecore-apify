...
export function createHttpErrorFromStatus(statusCode: number, message?: string): HttpError {
  const errorMessage = message;

  switch (statusCode) {
    case 400: return new BadRequestError(errorMessage);
    case 401: return new UnauthorizedError(errorMessage);
    case 402: return new PaymentRequiredError(errorMessage);
    case 403: return new ForbiddenError(errorMessage);
    case 404: return new NotFoundError(errorMessage);
    case 405: return new MethodNotAllowedError(errorMessage);
    case 406: return new NotAcceptableError(errorMessage);
    case 407: return new ProxyAuthenticationRequiredError(errorMessage);
    case 408: return new RequestTimeoutError(errorMessage);
    case 409: return new ConflictError(errorMessage);
    case 410: return new GoneError(errorMessage);
    case 411: return new LengthRequiredError(errorMessage);
    case 412: return new PreconditionFailedError(errorMessage);
    case 413: return new PayloadTooLargeError(errorMessage);
    case 414: return new UriTooLongError(errorMessage);
    case 415: return new UnsupportedMediaTypeError(errorMessage);
    case 416: return new RangeNotSatisfiableError(errorMessage);
    case 417: return new ExpectationFailedError(errorMessage);
    case 418: return new ImATeapotError(errorMessage);
    case 421: return new MisdirectedRequestError(errorMessage);
    case 422: return new UnprocessableEntityError(errorMessage);
    case 423: return new LockedError(errorMessage);
    case 424: return new FailedDependencyError(errorMessage);
    case 425: return new TooEarlyError(errorMessage);
    case 426: return new UpgradeRequiredError(errorMessage);
    case 428: return new PreconditionRequiredError(errorMessage);
    case 429: return new TooManyRequestsError(errorMessage);
    case 431: return new RequestHeaderFieldsTooLargeError(errorMessage);
    case 451: return new UnavailableForLegalReasonsError(errorMessage);
    case 500: return new InternalServerError(errorMessage);
    case 501: return new NotImplementedError(errorMessage);
    case 502: return new BadGatewayError(errorMessage);
    case 503: return new ServiceUnavailableError(errorMessage);
    case 504: return new GatewayTimeoutError(errorMessage);
    case 505: return new HttpVersionNotSupportedError(errorMessage);
    case 506: return new VariantAlsoNegotiatesError(errorMessage);
    case 507: return new InsufficientStorageError(errorMessage);
    case 508: return new LoopDetectedError(errorMessage);
    case 509: return new BandwidthLimitExceededError(errorMessage);
    case 510: return new NotExtendedError(errorMessage);
    case 511: return new NetworkAuthenticationRequiredError(errorMessage);
    default: return new HttpError(errorMessage || `Erro HTTP ${statusCode}`, statusCode);
  }
}
...
export const httpErrors = {
  ...
  proxyAuthenticationRequired: (message?: string) => new ProxyAuthenticationRequiredError(message),
  ...
  rangeNotSatisfiable: (message?: string) => new RangeNotSatisfiableError(message),
  expectationFailed: (message?: string) => new ExpectationFailedError(message),
  imateapot: (message?: string) => new ImATeapotError(message),
  misdirectedRequest: (message?: string) => new MisdirectedRequestError(message),
  ...
  preconditionRequired: (message?: string) => new PreconditionRequiredError(message),
  tooManyRequests: (message?: string) => new TooManyRequestsError(message),
  requestHeaderFieldsTooLarge: (message?: string) => new RequestHeaderFieldsTooLargeError(message),
  unavailableForLegalReasons: (message?: string) => new UnavailableForLegalReasonsError(message),
  ...
  httpVersionNotSupported: (message?: string) => new HttpVersionNotSupportedError(message),
  variantAlsoNegotiates: (message?: string) => new VariantAlsoNegotiatesError(message),
  insufficientStorage: (message?: string) => new InsufficientStorageError(message),
  loopDetected: (message?: string) => new LoopDetectedError(message),
  bandwidthLimitExceeded: (message?: string) => new BandwidthLimitExceededError(message),
  notExtended: (message?: string) => new NotExtendedError(message),
  networkAuthenticationRequired: (message?: string) => new NetworkAuthenticationRequiredError(message),
};
